...
class _MapScreenState extends State<MapScreen> {
  ...
  Future<void> _checkProgressAndMaybeReroute() async {
    ...
    // rough off-route detection: distance to nearest line segment > 30m → reroute
    ...
    if (d > 30) {
      ...
      // Update remaining by straight-line to end as a cheap estimate
      final end = line.last;
  ...
  double _distancePointToSegmentMeters(LatLng p, LatLng a, LatLng b){
    // quick planar approximation (ok for short segments)
